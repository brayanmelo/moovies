...
const Search = () => {
  ...
  return (
    <div className="lg:w-4/6 mx-auto px-6 h-full">
      <h1 className="text-xl break-all my-5 ">
        Resultados para:{" "}
      ...
      <div className=" grid grid-cols-2 justify-items-center sm:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 gap-x-4 gap-y-8 pb-12 ">
        {movies.length > 0 ? (
